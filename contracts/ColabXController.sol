...
import "./ICollabXController.sol";
import "./ICollabXStorage.sol";
import "./ICollabXPayments.sol";
import "./ICollabXMediation.sol";

contract CollabXController is ICollabXController, Ownable, Initializable {
  ...
  ICollabXStorage private storageContract;
  ICollabXPayments private paymentsContract;
  ICollabXMediationHandler private mediationContract;
  ...
  function setStorageAddress(address _storageAddress) public onlyOwner {
    ...
    storageContract = ICollabXStorage(storageAddress);
  }
  ...
  function setPaymentsAddress(address _paymentsAddress) public onlyOwner {
    ...
    paymentsContract = ICollabXPayments(_paymentsAddress);
  }
  ...
  function setMediationAddress(address _mediationAddress) public onlyOwner {
    ...
    mediationContract = ICollabXMediationHandler(_mediationAddress);
  }
