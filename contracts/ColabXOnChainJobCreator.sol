...
import "./ICollabXJobManager.sol";
import "./ICollabXJobClient.sol";
import "./ControllerOwnable.sol";
import "./ICollabXToken.sol";

contract CollabXOnChainJobCreator is ICollabXJobManager, ControllerOwnable, Initializable {
  ...
  function setTokenAddress(address _tokenAddress) public onlyOwner {
    ...
    tokenContract = ICollabXToken(tokenAddress);
  }
  ...
  function submitResults(
    ...
    ICollabXJobClient(offer.calling_contract).submitResults(
      id,
      dealId,
      dataId
    );
