...
contract ColabXOnChainJobCreator is
    IColabXJobManager,
    ControllerOwnable,
    Initializable
{
    ...
    function setTokenAddress(address _tokenAddress) public onlyOwner {
        ...
        tokenContract = IColabXToken(tokenAddress);
    }
    ...
    function runJob(
        ...
        // work on it's behalf
        require(
            tokenContract.allowance(payee, getControllerAddress()) >=
                requiredDeposit,
        ...
        emit JobAdded(nextJobID, msg.sender, payee, module, inputs);
    ...
    function submitResults(
        ...
        IColabXJobClient(offer.calling_contract).submitResults(
            id,
            dealId,
            dataId
        );
