...
contract ExampleClient is Ownable, Initializable, ICollabXJobClient {

  address private jobManagerAddress;
  ICollabXJobManager private jobManagerContract;
  ...
  function setJobManagerAddress(address _jobManagerAddress) public onlyOwner {
    ...
    jobManagerContract = ICollabXJobManager(jobManagerAddress);
  }
