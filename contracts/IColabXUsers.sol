...
interface IColabXUsers {
    ...
    function addUserToList(SharedStructs.ServiceType serviceType) external;

    function removeUserFromList(SharedStructs.ServiceType serviceType) external;
